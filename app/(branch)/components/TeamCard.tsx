      ...
      <CardContent className="">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-gray-500 text-sm">ID: {teamId}</p>
          </div>
        </div>
        ...
        <div className="space-y-2 mb-4">
          <div className="flex">
            ...
            <span className="text-base">{teamLeader}</span>
          </div>

          <div className="flex">
            <span className="font-bold text-base">Running Projects: &nbsp;</span>
            <span className="text-base">{runningProjects}</span>
          </div>

          <div className="flex">
            <span className="font-bold text-base">Delivered Projects: &nbsp;</span>
            <span className="text-base">{deliveredProjects}</span>
          </div>
          <div className="flex">
            <span className="font-bold text-base">Workload: &nbsp;</span>
            <span className="text-base">{workload}</span>
          </div>
        </div>
